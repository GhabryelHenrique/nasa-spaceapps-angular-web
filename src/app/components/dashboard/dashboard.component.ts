        ...
        <div class="container">
          <div class="header-content">
            <div class="welcome-section">
              <h1 *ngIf="currentUser">Olá, {{ getFirstName(currentUser.fullName) }}! 👋</h1>
            ...
            <div class="row g-4">
              <div class="col-md-4">
                <div class="action-card" (click)="navigateToProfile()">
                  ...
                  <p>{{ hasProfile ? 'Atualize suas informações' : 'Configure seu perfil de matchmaking' }}</p>
                  <div class="action-footer">
                    <span class="badge" [class]="hasProfile ? 'badge-success' : 'badge-warning'">
              ...
              <div class="col-md-4">
                <div class="action-card" (click)="navigateToMatches()">
                  ...
                  <div class="action-footer">
                    <span class="badge badge-info">{{ matchCount }} disponíveis</span>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="action-card" (click)="findMatches()">
                  ...
                  <div class="action-footer">
                    <span class="badge" [class]="isSearching ? 'badge-warning' : 'badge-secondary'">
              ...
              <div class="col-md-8">
                <div class="content-card">
                  ...
                  <div class="progress-list">
                    ...
                    <div class="progress-item" [class.completed]="hasProfile" [class.active]="!hasProfile">
                      <div class="progress-marker"></div>
                      <div class="progress-content">
                    ...
                    <div class="progress-item" [class.completed]="matchCount > 0" [class.active]="hasProfile && matchCount === 0">
                      <div class="progress-marker"></div>
                      <div class="progress-content">
